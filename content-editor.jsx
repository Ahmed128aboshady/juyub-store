      ...
      <div className="adm-editor" style={{ maxWidth: 820, marginTop: 18 }}>
        ...
        {sec === 'shop' && <>
          ...
          <div className="adm-sec">
            ...
            <p className="muted" style={{fontSize:13,marginBottom:12}}>{L('Paste an image or GIF link — shown below Good to Know in the shop sidebar.','الصق لينك صورة أو GIF — بتظهر تحت Good to Know في الشريط الجانبي.')}</p>
            <div className="field">
